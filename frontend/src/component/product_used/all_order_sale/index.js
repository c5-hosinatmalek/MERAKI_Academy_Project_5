...
const ALLORDERSALE = () => {
  ...
  return <div className="contener_all_order_sale">
            <div className="content_all_order_sale" >
        {state.allordersale&&state.allordersale.map((element,index)=>{
            console.log(element);
            return(
                <div className="content_one_order_sale" >

                    {element.admission_status?<div style={{background:`rgba(0, 128, 0, 0.63)`}} className="approvied" ><h1 className="fff" >Admission status</h1></div>:<div  style={{background:` rgba(192, 11, 11, 0.774)`}}  className="approvied" ><h1 className="fff" >Admission status</h1></div>}
                ...
                <div className="details_all_order">
                    ...
                    <h1>Admission status :{element.admission_status?"it has been accepted":"Under Review"} </h1>
